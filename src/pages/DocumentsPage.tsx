...
import { FolderOpen, FileText, Printer, Download, UploadCloud, ChevronRight, Check, Search, Calendar, FileType2 } from 'lucide-react';
                  ...
                  {previewCert ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 justify-center">
                        <Button variant="secondary" size="sm" icon={<Printer className="h-3.5 w-3.5" />} onClick={printCert}>
                          Imprimer
                        </Button>
                      </div>
                    </div>
            ...
            <Card className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <TemplateCard
                  ...
                  desc="Courrier type à l'attention des autorités locales pour manifestation extérieure."
                />
                <TemplateCard
                  title="Lettre d'invitation d'orateur"
                  desc="Modèle officiel pour inviter un orateur externe lors des cultes ou conventions."
                />
                <TemplateCard
                  title="Attestation de membre actif"
                  desc="Document certifiant l'appartenance et l'engagement d'un fidèle au temple."
                />
              </div>
            </Card>
          )}
            ...
            <Card className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <TemplateCard
                  ...
                  desc="Trame pour le bilan annuel de l'église locale destiné au bureau national."
                />
                <TemplateCard
                  title="Procès-verbal de conseil pastoral"
                  desc="Formulaire structuré pour consigner les décisions du conseil de l'église."
                />
              </div>
            </Card>
          )}
      ...
      {previewCert && (
        <Modal open onClose={() => setPreviewCert(null)} title="Aperçu avant impression" size="lg">
          ...
          <div className="flex justify-end gap-2 mt-4">
            ...
            <Button icon={<Printer className="h-4 w-4" />} onClick={printCert}>
              Lancer l'impression
            </Button>
          </div>
        </Modal>
...
function TemplateCard({ title, desc }: { title: string; desc: string }) {
  return (
    <div className="p-4 border border-ink-150 dark:border-ink-800 rounded-xl space-y-2 hover:shadow-xs hover:border-ink-300 dark:bg-ink-900/40">
      ...
      <div className="flex justify-end gap-1.5 pt-2 border-t border-ink-50 dark:border-ink-800">
